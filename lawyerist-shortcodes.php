...
function lawyerist_testimonial_shortcode( $atts, $quotation = null ) {
  ...
  return '<aside><blockquote class="testimonial" markdown="1"><span class="sponsored_testimonial_label">Sponsored Testimonial</span><span class="sponsored_testimonial_quotation">&ldquo;' . $quotation . '&rdquo;</span><span class="sponsored_testimonial_source postmeta">—' . $source . '</span></blockquote></aside>';
}
